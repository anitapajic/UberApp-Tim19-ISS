...
insert into users (dtype, firstname, lastname, email, profilePicture, telephoneNumber, address, password, active, blocked, vehicle_id) values ('Driver','tamara', 'dzambic', 'tdz@gmail.com','pic1', '22232', 'NS 12', '123', 'true', 'false', '1');
insert into users (dtype, firstname, lastname, email, profilePicture, telephoneNumber, address, password, active, blocked) values ('Passenger','tamara', 'dzambic', 'tdz2@gmail.com','pic2', '22232', 'NS 12', '123', 'true', 'false');
insert into users (dtype, firstname, lastname, email, profilePicture, telephoneNumber, address, password, active, blocked)  values ('Passenger','tamara', 'dzambic', 'tdz3@gmail.com','pic3', '22232', 'NS 12', '123', 'true', 'false');
